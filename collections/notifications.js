...
//notification of a reply to a user's comment.
/*switch checks for an event, then sees which case best matches the 
event. Using break prevents switch from running through all the cases. The
default event is to maintain status quo.*/
  switch(event){
    case 'newReply':
      var n = {
...
//once user clicks 'Mark all as read' the notifications bar fades out.
Meteor.methods({
